...
export const products: Product[] = [
  { id: '1', name: '18" Alaşım Jant Takımı', stock: 12, price: 15000, compatibility: 'VW Golf, Audi A3', imageUrl: findImage('product-wheel'), lastPurchaseDate: '2024-05-10' },
  { id: '2', name: 'LED Far Kiti', stock: 35, price: 2500, compatibility: 'BMW 3 Serisi, Mercedes C Serisi', imageUrl: findImage('product-headlight'), lastPurchaseDate: '2024-05-20' },
  { id: '3', name: 'Karbon Fiber Spoiler', stock: 8, price: 7500, compatibility: 'Universal', imageUrl: findImage('product-spoiler'), lastPurchaseDate: '2024-04-15' },
  { id: '4', name: 'Performans Egzoz Sistemi', stock: 5, price: 25000, compatibility: 'Ford Mustang, Chevrolet Camaro', imageUrl: findImage('product-exhaust'), lastPurchaseDate: '2024-05-01' },
  { id: '5', name: 'Yarış Koltuğu', stock: 16, price: 9000, compatibility: 'Universal', imageUrl: findImage('product-seat'), lastPurchaseDate: '2024-05-22' },
  { id: '6', name: 'Android Multimedya Ekranı', stock: 22, price: 6000, compatibility: 'Toyota Corolla, Honda Civic', imageUrl: findImage('product-multimedia'), lastPurchaseDate: '2024-05-18' },
];

export const transactions: Transaction[] = [
  { id: 't1', type: 'Satış', productName: 'LED Far Kiti', date: '2024-05-28', quantity: 2, amount: 5000 },
  { id: 't2', type: 'Alış', productName: '18" Alaşım Jant Takımı', date: '2024-05-27', quantity: 4, amount: -40000 },
